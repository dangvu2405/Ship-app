...
export function PositionFormDialog({
  ...
  const title = isViewMode ? t('common.view') : isEdit ? t('positions.editPosition') : t('positions.createPosition');
  const description = isViewMode
    ? t('positions.editDescription')
    : isEdit
      ? t('positions.editDescription')
      : t('positions.createDescription');
    ...
    hasRecordId && isLoadingData ? (
      ...
      <>
        <Alert
          ...
          description={t('formGuides.position')}
          showIcon
