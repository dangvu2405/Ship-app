...
export function InvoicesList() {
  ...
  const columns: DataTableColumn<Invoice>[] = [
    ...
    { key: 'total_amount', header: t('invoices.totalAmount'), dataIndex: 'total_amount' },
    { key: 'status', header: t('common.status'), dataIndex: 'status' },
    {
      ...
      render: (record) => (
        <div className="flex gap-2">
          ...
          <Button variant="ghost" size="sm" className="h-8 w-8 p-0" onClick={(e) => { e.stopPropagation(); edit('invoices', record.id); }}>
  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Button onClick={() => create('invoices')} className="gap-2">
