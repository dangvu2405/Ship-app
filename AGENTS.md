...
This project is indexed by GitNexus as **Ship-app** (4801 symbols, 8185 relationships, 205 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
