...
This project is indexed by GitNexus as **Ship-app** (4992 symbols, 8497 relationships, 207 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
